...
public class DistributeResourcesTest {
    ...
    void playerB_has_threeCafe() {
        // given
        setPlayerCardCountForCards(playerB,3,cafe);
    ...
    @Test
    @DisplayName(
                    "given A,B,C,D 玩家 (A,B,C 各3 Coin) 玩家B、C各擁有一間咖啡館，玩家D有2元"+
                    "when D 玩家擲骰子是3時，系統分配資源後 " +
    ...
    private void setPlayerCardCountForCards(Player player, int times, Establishment establishment) {
